...
include("models/objemptax201.model.php");
include("../models/objemptax201.model.php");
class ControllerEmpobjemptax201{

	/*=============================================
	CREATE CUSTOMERS
	=============================================*/

	static public function ctrCreateEmpobjemptax201(){
		...
		if(isset($_POST["newName"])){
			...
			if(isset($_POST["newName"])
				...
				$fileddate = $_POST["newfileddate"];
			   	...
			   	$answer = ModelEmpobjemptax201::mdlAddEmpobjemptax201($table, $data);
				//print_r($answer);
				//exit();
	...
	static public function ctrShowEmpobjemptax201($item, $value){

		$table = "objemptax201";

		$answer = ModelEmpobjemptax201::mdlShowEmpobjemptax201($table, $item, $value);
	...
	static public function ctrEditEmpobjemptax201(){
		...
		if(isset($_POST["editname"])){
			...
			if($_POST["editname"]
				...
				$nextdue = $month.$year;
			   	...
			   	$answer = ModelEmpobjemptax201::mdlEditEmpobjemptax201($table, $data);
				//print_r($answer);
	...
	static public function ctrDeleteEmpobjemptax201(){
		...
		if(isset($_GET["regNumber"])){
			...
			$answer = ModelEmpobjemptax201::mdlDeleteEmpobjemptax201($table, $data);
	...
	static public function ctrSendReminder($item, $value){
		...
		$table = "Empobjemptax201";

		$answer = ModelEmpobjemptax201::mdlSendReminder($table, $item, $value);
	...
	public function ctrSendEmail(){
		...
		$Customers = controllerEmpobjemptax201::ctrSendReminder($item, $valor);
...
$ctrSendReminder = new ControllerEmpobjemptax201();
