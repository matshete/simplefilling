...
class ControllerEmpcidb{

	/*=============================================
	CREATE CUSTOMERS
	=============================================*/

	static public function ctrCreateEmpcidb(){
		...
		if(isset($_POST["newName"])){
			...
			if(isset($_POST["newName"])
				...
				$fileddate = $_POST["newfileddate"];
			   	...
			   	$answer = ModelEmpcidb::mdlAddEmpcidb($table, $data);
				//print_r($answer);
				//exit();
	...
	static public function ctrShowEmpcidb($item, $value){

		$table = "cidb";

		$answer = ModelEmpcidb::mdlShowEmpcidb($table, $item, $value);
	...
	static public function ctrEditEmpcidb(){
		...
		if(isset($_POST["editname"])){
			...
			if($_POST["editname"]
				...
				$armonth->modify('-1 month');
			   	...
			   	$answer = ModelEmpcidb::mdlEditEmpcidb($table, $data);
				//print_r($answer);
	...
	static public function ctrDeleteEmpcidb(){
		...
		if(isset($_GET["regNumber"])){
			...
			$answer = ModelEmpcidb::mdlDeleteEmpcidb($table, $data);
