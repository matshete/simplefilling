...
include("models/emp201.model.php");
include("../models/emp201.model.php");
class Controlleremp201{
	...
	static public function ctrSendReminder($item, $value){
		...
		$answer = Modelemp201::mdlSendReminder($table, $item, $value);
	...
	public function ctrSendEmail(){
		...
		$Customers = controlleremp201::ctrSendReminder($item, $valor);
...
$sendReminder = new  Controlleremp201();
