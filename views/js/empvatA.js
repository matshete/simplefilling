...
$(".tables").on("click", "tbody .btnEditEmpvatA", function(){
 	...
 	data.append("validateregNumber", regnumber);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newEmpvatA").parent().after('<div class="alert alert-warning">This Registration Number Already Exist!</div>');
...
$(".tables").on("click", "tbody .btnDeleteEmpvatA", function(){
	...
	swal({
        ...
        if (result.value) {
            ...
            window.location = "index.php?route=vatA&regNumber="+regNumber;
        }
