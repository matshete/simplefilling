...
$(".tables").on("click", "tbody .btnEditEmpvatC", function(){
 	...
 	data.append("validateregNumber", regnumber);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newEmpvatC").parent().after('<div class="alert alert-warning">This Registration Number Already Exist!</div>');
...
$(".tables").on("click", "tbody .btnDeleteEmpvatC", function(){
	...
	swal({
        ...
        if (result.value) {
            ...
            window.location = "index.php?route=vatC&regNumber="+regNumber;
        }
