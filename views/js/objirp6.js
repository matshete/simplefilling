...
$(".tables").on("click", "tbody .btnEditEmpobjirp6", function(){
 	...
 	data.append("validateregNumber", regnumber);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newEmpobjirp6").parent().after('<div class="alert alert-warning">This Registration Number Already Exist!</div>');
...
$(".tables").on("click", "tbody .btnDeleteEmpobjirp6", function(){
	...
	swal({
        ...
        if (result.value) {
            ...
            window.location = "index.php?route=objirp6&regNumber="+regNumber;
        }
