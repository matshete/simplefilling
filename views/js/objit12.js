...
$(".tables").on("click", "tbody .btnEditEmpobjit12", function(){
 	...
 	data.append("validateregNumber", regnumber);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newEmpobjit12").parent().after('<div class="alert alert-warning">This Registration Number Already Exist!</div>');
...
$(".tables").on("click", "tbody .btnDeleteEmpobjit12", function(){
	...
	swal({
        ...
        if (result.value) {
            ...
            window.location = "index.php?route=objit12&regNumber="+regNumber;
        }
