...
$(".tables").on("click", "tbody .btnEditEmpcoida", function(){
 	...
 	data.append("validateregNumber", regnumber);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newEmpcoida").parent().after('<div class="alert alert-warning">This Registration Number Already Exist!</div>');
...
$(".tables").on("click", "tbody .btnDeleteEmpcoida", function(){
	...
	swal({
        ...
        if (result.value) {
            ...
            window.location = "index.php?route=coida&regNumber="+regNumber;
        }
