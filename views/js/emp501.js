...
$(".tables").on("click", "tbody .btnEditEmp501", function(){
 	...
 	data.append("validateregNumber", regnumber);
      ...
      success: function(answer){ 
      	...
      	if(answer){
      		...
      		$("#newEmp501").parent().after('<div class="alert alert-warning">This Registration Number Already Exist!</div>');
...
$(".tables").on("click", "tbody .btnDeleteEmp501", function(){
	...
	swal({
        ...
        if (result.value) {
            ...
            window.location = "index.php?route=emp501&regNumber="+regNumber;
        }
