...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Value Added Tax Category(B) Management
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addEmpvatB">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = ControllerEmpvatB::ctrShowEmpvatB($item, $valor);
              ...
              echo '<tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditEmpvatB" data-toggle="modal" data-target="#modalEditEmpvatB" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteEmpvatB" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
...
<div id="addEmpvatB" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		   ...
		   <!-- REGISTRATION NUMBER INPUT -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" maxlength="14" id="newEmpvatB" name="newRegNumber" value ="<?php if (isset($_POST["newRegNumber"])){echo $_POST["newRegNumber"];}?>" placeholder="Enter Tax Reference No">
              </div>
            </div>
      ...
      <?php
        ...
        $createEmpvatB = new ControllerEmpvatB();
        $createEmpvatB -> ctrCreateEmpvatB();
...
<div id="modalEditEmpvatB" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
        ...
        $EditEmpvatB = new ControllerEmpvatB();
        $EditEmpvatB -> ctrEditEmpvatB();
...
<?php
  ...
  $deleteEmpvatB = new ControllerEmpvatB();
  $deleteEmpvatB -> ctrDeleteEmpvatB();
