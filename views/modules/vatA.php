...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Value Added Tax Category(A) Management
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addempvatA">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = controllervatA::ctrShowvatA($item, $valor);
                ...
                echo    '<td>'.$email_sent.'</td>          
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditEmpvatA" data-toggle="modal" data-target="#modalEditempvatA" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteEmpvatA" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
...
<div id="addempvatA" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		   ...
		   <!-- REGISTRATION NUMBER INPUT -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" maxlength="14" id="newEmpvatA" name="newRegNumber" value ="<?php if (isset($_POST["newRegNumber"])){echo $_POST["newRegNumber"];}?>" placeholder="Enter Tax Reference No">
              </div>
            </div>
      ...
      <?php
        ...
        $createEmpvatA = new ControllerempvatA();
        $createEmpvatA -> ctrCreateempvatA();
...
<div id="modalEditempvatA" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
        ...
        $EditEmpvatA = new ControllerempvatA();
        $EditEmpvatA -> ctrEditempvatA();
...
<?php
  ...
  $deleteEmpvatA = new ControllerempvatA();
  $deleteEmpvatA -> ctrDeleteempvatA();
