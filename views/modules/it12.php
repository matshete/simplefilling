...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Income Tax (ITR14/ITR12T/IT12EI) Management
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addEmpit12">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = ControllerEmpit12::ctrShowEmpit12($item, $valor);
              ...
              echo    '<td>'.$email_sent.'</td>          
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditEmpit12" data-toggle="modal" data-target="#modalEditEmpit12" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteEmpit12" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
...
<div id="addEmpit12" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		   ...
		   <!-- REGISTRATION NUMBER INPUT -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" maxlength="14" id="newEmpit12" name="newRegNumber" value ="<?php if (isset($_POST["newRegNumber"])){echo $_POST["newRegNumber"];}?>" placeholder="Enter Tax Reference No">
              </div>
            </div>
      ...
      <?php
        ...
        $createEmpit12 = new ControllerEmpit12();
        $createEmpit12 -> ctrCreateEmpit12();
...
<div id="modalEditEmpit12" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
        ...
        $EditEmpit12 = new ControllerEmpit12();
        $EditEmpit12 -> ctrEditEmpit12();
...
<?php
  ...
  $deleteEmpit12 = new ControllerEmpit12();
  $deleteEmpit12 -> ctrDeleteEmpit12();
