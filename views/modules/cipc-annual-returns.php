...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      CIPC Annual Returns Management
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = controllerAnnuals::ctrShowAnnuals($item, $valor);
                     ...
                     echo ' <td>'.$status.'</td> 
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditAnnuals" data-toggle="modal" data-target="#modalEditAnnuals" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteAnnuals" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
