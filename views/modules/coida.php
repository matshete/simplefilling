...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      COIDA Return Of Earnings(RE) Management
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addEmpcoida">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = ControllerEmpcoida::ctrShowEmpcoida($item, $valor);
              ...
              echo '<tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditEmpcoida" data-toggle="modal" data-target="#modalEditEmpcoida" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteEmpcoida" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
...
<div id="addEmpcoida" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST">
        ...
        <div class="modal-header" style="background: #3c8dbc; color: #fff">
          ...
          <h4 class="modal-title">Add coida Customer</h4>
		   ...
		   <!-- REGISTRATION NUMBER INPUT -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" maxlength="14" id="newEmpcoida" name="newRegNumber" value ="<?php if (isset($_POST["newRegNumber"])){echo $_POST["newRegNumber"];}?>" placeholder="Enter Reference No" required>
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="submit" class="btn btn-primary">Save COIDA Customer</button>
        </div>
      </form>

      <?php

        $createEmpcoida = new ControllerEmpcoida();
        $createEmpcoida -> ctrCreateEmpcoida();
...
<div id="modalEditEmpcoida" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Edit coida Customer</h4>
      ...
      <?php
        ...
        $EditEmpcoida = new ControllerEmpcoida();
        $EditEmpcoida -> ctrEditEmpcoida();
...
<?php
  ...
  $deleteEmpcoida = new ControllerEmpcoida();
  $deleteEmpcoida -> ctrDeleteEmpcoida();
