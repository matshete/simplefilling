...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      employee's tax (emp501) Management
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addemp501">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = controlleremp501::ctrShowemp501($item, $valor);
              ...
              echo    '<td>'.$email_sent.'</td>          
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditEmp501" data-toggle="modal" data-target="#modalEditemp501" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteEmp501" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
...
<div id="addemp501" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		   ...
		   <!-- REGISTRATION NUMBER INPUT -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" maxlength="14" id="newEmp501" name="newRegNumber" value ="<?php if (isset($_POST["newRegNumber"])){echo $_POST["newRegNumber"];}?>" placeholder="Enter Tax Reference No">
              </div>
            </div>
      ...
      <?php
        ...
        $createEmp501 = new Controlleremp501();
        $createEmp501 -> ctrCreateemp501();
...
<div id="modalEditemp501" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
        ...
        $EditEmp501 = new Controlleremp501();
        $EditEmp501 -> ctrEditemp501();
...
<?php
  ...
  $deleteEmp501 = new Controlleremp501();
  $deleteEmp501 -> ctrDeleteemp501();
