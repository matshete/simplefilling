...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      EMPLOYEE MANAGEMENT IRP6 MANAGEMENT
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addempirp6">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = controllerempirp6::ctrShowempirp6($item, $valor);
                ...
                echo    '<td>'.$email_sent.'</td>          
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditEmpirp6" data-toggle="modal" data-target="#modalEditempirp6" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteEmpirp6" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
...
<div id="addempirp6" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		   ...
		   <!-- REGISTRATION NUMBER INPUT -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" maxlength="14" id="newEmpirp6" name="newRegNumber" value ="<?php if (isset($_POST["newRegNumber"])){echo $_POST["newRegNumber"];}?>" placeholder="Enter Tax Reference No">
              </div>
            </div>
      ...
      <?php
        ...
        $createEmpirp6 = new Controllerempirp6();
        $createEmpirp6 -> ctrCreateempirp6();
...
<div id="modalEditempirp6" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
        ...
        $EditEmpirp6 = new Controllerempirp6();
        $EditEmpirp6 -> ctrEditempirp6();
...
<?php
  ...
  $deleteEmpirp6 = new Controllerempirp6();
  $deleteEmpirp6 -> ctrDeleteempirp6();
