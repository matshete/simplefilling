...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Employee IRP6 Objections Management
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addEmpobjit12">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tables" width="100%">
          ...
          <?php
            ...
            $Customers = ControllerEmpobjit12::ctrShowEmpobjit12($item, $valor);
              ...
              echo '<tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <button class="btn btn-warning btnEditEmpobjit12" data-toggle="modal" data-target="#modalEditEmpobjit12" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger btnDeleteEmpobjit12" regNumber="'.$value["REGISTRATION_NUMBER"].'"><i class="fa fa-times"></i></button>
...
<div id="addEmpobjit12" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST">
        ...
        <div class="modal-header" style="background: #3c8dbc; color: #fff">
          ...
          <h4 class="modal-title">Add objit12 Customer</h4>
		   ...
		   <!-- REGISTRATION NUMBER INPUT -->
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" maxlength="14" id="newEmpobjit12" name="newRegNumber" value ="<?php if (isset($_POST["newRegNumber"])){echo $_POST["newRegNumber"];}?>" placeholder="Enter Reference No" required>
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="submit" class="btn btn-primary">Save objit12 Customer</button>
        </div>
      </form>

      <?php

        $createEmpobjit12 = new ControllerEmpobjit12();
        $createEmpobjit12 -> ctrCreateEmpobjit12();
...
<div id="modalEditEmpobjit12" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Edit objit12 Customer</h4>
      ...
      <?php
        ...
        $EditEmpobjit12 = new ControllerEmpobjit12();
        $EditEmpobjit12 -> ctrEditEmpobjit12();
...
<?php
  ...
  $deleteEmpobjit12 = new ControllerEmpobjit12();
  $deleteEmpobjit12 -> ctrDeleteEmpobjit12();
