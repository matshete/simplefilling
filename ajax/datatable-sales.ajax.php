			...
			"data":[';
				...
				for($i=0; $i < count($products); $i++){
					...
					=============================================*/
		  			...
		  			$btn_image= "<div class='btn-group'><button class='btn btn-primary addProductSale recoverButton' idProduct='".$products[$i]["id"]."'>".$image."</button></div>";
